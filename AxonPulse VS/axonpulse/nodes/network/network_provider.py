...
class NetworkProviderNode(ProviderNode):
    ...
    def __init__(self, node_id, name, bridge):
        ...
        self.properties["Max Requests Per Sec"] = 0  # 0 = unlimited
    ...
    def start_scope(self, **kwargs):
        ...
        self.bridge.set(f"{self.node_id}_Max Requests Per Sec", self.properties.get("Max Requests Per Sec", 0), self.name)
        self.bridge.set(f"{self.node_id}_Last Request Time", 0, self.name)
