...
class NodeFactory:
    ...
    # [REMOVED] Local analyze_subgraph_ports removed in favor of axonpulse.core.subgraph_utils
    ...
    def create_standard_node(self, node_type, pos):
        ...
        if node_class:
            ...
            try:
                ...
                path = getattr(node_class, "graph_path", None)
                if path: logical_node.properties["Graph Path"] = path
    ...
    def create_subgraph_node(self, file_path, pos):
        ...
        if node_class:
            ...
            try:
                ...
                logical_node.properties["Graph Path"] = file_path
                new_node.node = logical_node
