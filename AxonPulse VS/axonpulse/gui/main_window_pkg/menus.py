...
class MenusMixin:
    def create_menu(self):
        ...
        tools_menu.addAction(self.import_graph_action)
        tools_menu.addSeparator()
        tools_menu.addAction(self.vault_action)
    ...
    def show_readme(self):
        from axonpulse.gui.dialogs.readme_viewer import ReadmeViewer
        import os
        # Assume README.md is in project root
        # We are in axonpulse/gui/main_window_pkg/menus.py
        # Root is ../../../
