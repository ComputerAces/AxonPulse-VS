...
class ActionsMixin:
    def create_actions(self):
        ...
        self.import_graph_action = QAction("Import Graph to Library...", self)
        self.import_graph_action.triggered.connect(self.import_to_library)

        self.vault_action = QAction("Enterprise Vault (Secrets)...", self)
        from PyQt6.QtWidgets import QStyle
        self.vault_action.setIcon(style.standardIcon(QStyle.StandardPixmap.SP_CustomBase)) # fallback
        self.vault_action.triggered.connect(self.open_vault)
    ...
    def spawn_minimap_window(self):
        from axonpulse.gui.minimap_window import StandaloneMinimapWindow
    ...
    def open_vault(self):
        from axonpulse.gui.dialogs.vault_dialog import VaultDialog
    ...
    def toggle_wire_legend(self):
        ...
        if not hasattr(self, '_wire_legend_window'):
            from axonpulse.gui.wire_legend import WireLegendV2
    ...
    def show_about(self):
        from axonpulse.gui.dialogs.about_dialog import AboutDialog
