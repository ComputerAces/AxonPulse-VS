...
class ReadmeViewer(QDialog):
    def __init__(self, parent=None, readme_path="README.md"):
        ...
        self.setWindowTitle("AxonPulse VS - Documentation")
        self.resize(800, 600)
    ...
    def load_file(self, file_path):
        ...
        try:
            ...
            # PyQt6 setMarkdown fails on raw HTML <img> tags. Convert to Markdown syntax.
            import re
            # Extract src attribute and optionally alt attribute
