...
echo.
echo ========================================================
echo               AXONPULSE VS - FIRST TIME SETUP
echo ========================================================
echo.
...
REM Run the AxonPulse Architect GUI
if exist "axonpulse\gui\main_window.py" (
    echo Launching AxonPulse VS Architect...
    python "axonpulse\gui\main_window.py" %*
) else (
    echo Error: axonpulse\gui\main_window.py not found.
)
