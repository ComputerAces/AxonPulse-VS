...
def run_headless(file_path):
    ...
    print(f"AxonPulse VS - Headless Mode")
    ...
    # 2. Load Graph
    from axonpulse.core.loader import load_graph_from_file
    try:
    ...
    if "--headless" in sys.argv:
        try:
            ...
            if idx + 1 < len(sys.argv):
                ...
                print("Usage: axonpulse/gui/main_window.py --headless <path_to_graph.syp>")
        except Exception as e:
