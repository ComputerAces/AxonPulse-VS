...
from axonpulse.utils.file_utils import serialize_to_yaml, parse_yaml_or_json
...
class NodeCanvas(QGraphicsView):
    ...
    def copy_selection(self):
        ...
        if data["nodes"] or data["frames"]:
            ...
            clipboard.setText("axonpulse_copy:" + serialize_to_yaml(data))
    ...
    def paste_selection(self):
        ...
        clipboard = QApplication.clipboard()
        text = clipboard.text()
        if text.startswith("axonpulse_copy:"):
            try:
                data = parse_yaml_or_json(text.replace("axonpulse_copy:", ""))
    ...
    def delete_selection(self):
        ...
        if self.parent() and hasattr(self.parent(), 'undo_stack'):
            from axonpulse.gui.undo_commands import DeleteItemsCommand
    ...
    def create_standard_node(self, node_type, pos):
        if self.parent() and hasattr(self.parent(), 'undo_stack'):
            from axonpulse.gui.undo_commands import AddNodeCommand
    ...
    def _show_create_node_menu(self, scene_pos, global_pos):
        ...
        from axonpulse.gui.dialogs.quick_picker import QuickPicker
    ...
    def mouseReleaseEvent(self, event):
        ...
        if hasattr(self, '_move_start_positions') and self._move_start_positions:
            ...
            if moved_nodes and self.parent() and hasattr(self.parent(), 'undo_stack'):
                from axonpulse.gui.undo_commands import MoveNodeCommand
