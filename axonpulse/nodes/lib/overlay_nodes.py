...
class OverlayHighlighterNode(SuperNode):
    ...
    def _show_overlay(self, x, y, w, h, r, g, b, a, duration_ms, thickness):
        ...
        try:
            ...
            def create_and_show():
                ...
                overlay.show()
                if not hasattr(app, '_axonpulse_overlays'):
                    app._axonpulse_overlays = []
                app._axonpulse_overlays.append(overlay)
    ...
    def _cleanup_overlay(app, overlay):
        ...
        try:
            if hasattr(app, '_axonpulse_overlays') and overlay in app._axonpulse_overlays:
                app._axonpulse_overlays.remove(overlay)
        except Exception:
            pass
